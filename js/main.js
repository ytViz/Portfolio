...
function launchTheRocket(a, b, c) {
    ...
    tab.document.documentElement.innerHTML = '<!DOCTYPE html><html><head><title>Classes</title><link rel="icon" type="image/png" href="https://ssl.gstatic.com/classroom/favicon.png"><style>body {margin:0;overflow:hidden}</style></head><body>tab.document.documentElement.innerHTML = "tab.document.documentElement.innerHTML = "<iframe style="width: 100%; height: 100%; overflow: show;" src="' + arguments[0] + '" width="100" height="100" scrolling="yes">Iframes not supported</iframe>"</body></html>';
    tab.document.close();
